...
public class ProductController {
    ...
    public String saveProduct(@ModelAttribute("productDto") ProductDto product,
                              ...
                              @RequestParam("imageProduct1") MultipartFile imageProduct1,
                              @RequestParam("imageProduct2") MultipartFile imageProduct2,
                              @RequestParam("imageProduct3") MultipartFile imageProduct3,
                              @RequestParam("imageProduct4") MultipartFile imageProduct4,
                              RedirectAttributes redirectAttributes, Principal principal) {
        try {
            if (principal == null) {
                return "redirect:/login";
            }
            productService.save(imageProduct, imageProduct1,
                    imageProduct2, imageProduct3, imageProduct4, product);
    ...
    public String updateProduct(@ModelAttribute("productDto") ProductDto productDto,
        ...
        try {
            ...
            productService.update(imageProduct, imageProduct1,
                    imageProduct2, imageProduct3, imageProduct4, productDto);
