...
public interface ProductService {
    ...
    Product save(MultipartFile imageProduct, MultipartFile imageProduct1,
                 MultipartFile imageProduct2, MultipartFile imageProduct3,
                 MultipartFile imageProduct4, ProductDto product);

    Product update(MultipartFile imageProduct, MultipartFile imageProduct1,
                   MultipartFile imageProduct2, MultipartFile imageProduct3,
